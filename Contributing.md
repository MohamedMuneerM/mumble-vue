...
> ⚠ Those who want to contribute on the repo, please refer to the [README.md](https://github.com/PraveenMalethia/mumble-vue/blob/master/README.md) and read the [Code Of Conduct](https://github.com/PraveenMalethia/mumble-vue/blob/master/CodeOfConduct.md) for more informations.
...
<br />
So by participating and contributing to this project, you agree to our [Code of Conduct](https://github.com/PraveenMalethia/mumble-vue/blob/master/CodeOfConduct.md).
